...
}(jQuery);$(document).delegate("input[data-input-highlight],input[data-change-highlight],select[data-input-highlight],select[data-change-highlight]", "change", function(){
    var node = $(this);
    var val = node.val();
    if(val == ""){
